 ...
 *  pressure
 *  
 *  This program uses a sparkfun pressure sensor via I2C linked below 
 *  https://learn.sparkfun.com/tutorials/ms5803-14ba-pressure-sensor-hookup-guide?_ga=2.117397056.759073936.1668360698-1974159909.1666213707&_gac=1.248777589.1668360698.CjwKCAjw8JKbBhBYEiwAs3sxNzoG9bwRz6KTfhaErJab2YDNXdZyI1iYctUPexhotLz5Sb8dZRTg2RoCwLEQAvD_BwE
 *
 *  Pressure sensor is connected to MCU via Sparkfun I2C multiplexer 
 */
...
const int pressure_port = 3; //IMU plugged into port 2 of mux
...
void setup() { 
  ...
  #if !NDEBUG
    serialDebug.printlnOutputStream(serialDebug);
  #endif
