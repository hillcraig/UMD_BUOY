    ...
    case start_9603:
      ...
      else
      {
       ...
       /* // Assemble the message using sprintf
        ...
        sprintf(outBuffer, "%d%s%s%s%s%s,%s,%s,%s,%s,%d,%s,%s,%s,%d", agtYear, gnssMonth, gnssDay, gnssHour, gnssMin, gnssSec, 
          latStr, lonStr, altStr, speedStr, agtSatellites, airTempStr, waterTempStr,vbatStr, iterationCounter);
